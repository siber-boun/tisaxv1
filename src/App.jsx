    ...
    <>
      ...
      {screen === "stage2Results" && (
        <div className="results-wrapper">
          ...
          <ScoreDashboard results={activeResults} executiveSummary={executiveSummary} text={text.results} profile={profile} answers={stage2Answers} sections={stage2Sections} />

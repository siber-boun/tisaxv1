      ...
      <div className="dashboard-layout">
        ...
        <nav className="sidebar-nav">
          <ul>
            <li>
              <button 
                className={`nav-item ${activeTab === "hizli-test" ? "active" : ""}`}
                onClick={() => onTabChange("hizli-test")}
              >
                <span className="icon">
            ...
            <li>
              <button 
                className={`nav-item ${activeTab === "tisax" ? "active" : ""}`}
                onClick={() => onTabChange("tisax")}
              >
                <span className="icon">
            ...
            <li>
              <button 
                className={`nav-item ${activeTab === "varlik" ? "active" : ""}`}
                onClick={() => onTabChange("varlik")}
              >
                <span className="icon">
            ...
            <li>
              <button 
                className={`nav-item ${activeTab === "tehdit" ? "active" : ""}`}
                onClick={() => onTabChange("tehdit")}
              >
                <span className="icon">
            ...
            <li>
              <button 
                className={`nav-item ${activeTab === "zafiyet" ? "active" : ""}`}
                onClick={() => onTabChange("zafiyet")}
              >
                <span className="icon">
